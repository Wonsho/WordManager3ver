...
public class AddWordViewModel extends ViewModel {
    ...
    public void updateWordListAverage() {
       int average =  MainViewModel.getAverageWordGradeInWordList(this.wordListMutableLiveData.getValue());
        WordList wordList = this.wordListMutableLiveData.getValue();
